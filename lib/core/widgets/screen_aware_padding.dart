...
class ScreenAwarePadding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    else if (size.height > 750 && size.height <= 900) {
      top = 32.0;
      bottom = 64.0;
    }
    else if (size.height > 900 && size.height <= 1200) {
      top = 64.0;
      bottom = 128.0;
    }
    ...
    else if (size.width > 400 && size.width <= 600) {
      left = 32.0;
      right = 32.0;
    }
    ...
    var pad = EdgeInsets.only(left: left, bottom: bottom, right: right, top: top);
