...
import 'package:ezsale/core/auth/handlers/email/link/link_account_view_model.dart';
...
class LinkEmailAccountState extends FormProgressActionableState<LinkEmailAccount> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _passwordField() {
    return ListTile(
      ...
      title: TextFormField(
        ...
        onSaved: (val) => _viewModel.password,
      ),
    );
  }
