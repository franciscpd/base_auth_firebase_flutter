...
import 'package:ezsale/core/widgets/modal_app_bar.dart';
import 'package:ezsale/core/widgets/form_progress_actionable_state.dart';
import 'package:ezsale/core/auth/handlers/email/forgotPassword/forgot_password_view_model.dart';
          ...
          children: <Widget>[
            ...
            _showSendMessage
              ? Padding(
                ...
                child: Text(
                  'An email has ben sent to this address. Please open the email and follow the instructions to reset your password',
  ...
  Widget build(BuildContext context) {
    return PlatformScaffold(
      appBar: ModalAppBar(
        ...
        hideAccept: true,
        closeAction: super.showProgress ? null : () => Navigator.maybePop(context),
      ),
      body: Material(
