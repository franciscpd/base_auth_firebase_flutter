...
import 'package:ezsale/core/widgets/header_button.dart';
import 'package:ezsale/core/widgets/email_image_circle_avatar.dart';
import 'package:ezsale/core/widgets/tablet_aware_layout_builder.dart';
import 'package:ezsale/core/widgets/form_progress_actionable_state.dart';
import 'package:ezsale/core/widgets/throttled_text_editing_controller.dart';
import 'package:ezsale/core/auth/handlers/email/signIn/sign_in_view_model.dart';
import 'package:ezsale/core/auth/handlers/user/termsAcceptance/terms_accept_modal.dart';
import 'package:ezsale/core/auth/handlers/email/forgotPassword/forgot_password_page.dart';

class SignInPassword extends StatefulWidget {
  SignInPassword(
    {
      this.displaySignInButton = true,
      this.popRouteOnSignin = false,
    }
  );
...
class SignInPasswordState extends FormProgressActionableState<SignInPassword> {
  ...
  Future _signInWithEmailPassword(AuthService authService) async {
    ...
    try {
      await provider?.signIn({'email': _viewModel.email, 'password': _viewModel.password});
